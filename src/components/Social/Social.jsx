  ...
  return (
    <div id="contato">
      ...
      <div className="containerBoxIconsGeral">
        ...
        <a
          href="mailto:gui.m.neves01@gmail.com"
          data-aos="zoom-in"
          data-aos-duration="1000"
          data-aos-easing="ease-in-out"
        >
        ...
        <a
          href="https://github.com/GuiMachado001"
          target="_blank"
          style={{ textDecoration: "none" }}
        >
          <div
            className="containerBoxIcons"
            data-aos="zoom-in"
            data-aos-duration="1000"
            data-aos-easing="ease-in-out"
          >
        ...
        <a
          href="https://www.linkedin.com/in/guilherme-machado-neves-396693279/"
          target="_blank"
          style={{ textDecoration: "none" }}
        >
          <div
